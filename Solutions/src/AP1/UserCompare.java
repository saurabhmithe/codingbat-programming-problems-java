...
public class UserCompare {
    ...
    // is negative/0/positive to indicate how str1 is ordered to str2 (the value is not limited
    // to -1/0/1). (On the AP, there would be two User objects, but here the code simply takes the
    // two strings and two ints directly. The code logic is the same.)
