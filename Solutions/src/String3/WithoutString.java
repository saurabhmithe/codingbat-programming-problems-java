...
public class WithoutString {
    ...
    // remove string have been removed (not case sensitive). You may assume that the remove string is length
    // 1 or more. Remove only non-overlapping instances, so with "xxx" removing "xx" leaves "x".
